...
public class VagaController {
	...
	public String cadastrarVaga(@PathVariable("idEmpresa") Long idEmpresa, @ModelAttribute("vaga") Vaga vaga,
	...
	public String editarVaga(@PathVariable("id1") Long idEmpresa, @PathVariable("id2") Long idVaga,
			@ModelAttribute("vaga") Vaga vaga, RedirectAttributes redirectAttributes) {
	...
	public String deletarVaga(@PathVariable("id1") Long idEmpresa, @PathVariable("id2") Long idVaga,
			@ModelAttribute("vaga") Vaga vaga, RedirectAttributes redirectAttributes) {
	...
	public String visualizarCandidatos(@PathVariable("id1") Long idEmpresa, @PathVariable("id2") Long idVaga,
			Model model) {
